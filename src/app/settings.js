  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="relative">
        <Input placeholder={"•".repeat(openaiApiKey.length)} type={keyIsVisible ? 'text' : 'password'} onChange={(e) => setOpenaiApiKey(e.target.value)}/>
        <Button
          variant="ghost"
          size="icon"
      ...
      <div className="mt-4 flex justify-end">
        <DialogClose asChild>
          <Button className="mr-2" variant="secondary"> Close </Button>
        </DialogClose>
